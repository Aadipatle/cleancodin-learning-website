      ...
      <div className={Css.slider}>
        <div className={Css.slider_container}>
          <div className={Css.slider_animation}>
            ...
            <p data-aos="zoom-in" data-aos-duration="1000" style={{ fontSize: '20px' }}>"Support small business and join the nationwide movement to encourage commercial support for the millions of minority owned businesses helping world economy."</p>

            <button data-aos="fade-up" data-aos-duration="1200">Get Started <span>▶</span></button>
          </div>
